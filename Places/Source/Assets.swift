...
internal enum Asset {
  ...
  internal static let fillEye = ImageAsset(name: "fillEye")
  internal static let fillFavorite = ImageAsset(name: "fillFavorite")
  internal static let filledPlus = ImageAsset(name: "filledPlus")
