...
internal enum Asset {
  ...
  internal static let _1background0 = ColorAsset(name: "1background0")
  internal static let _1background1 = ColorAsset(name: "1background1")
  internal static let _1background2 = ColorAsset(name: "1background2")
  internal static let _1foreground0 = ColorAsset(name: "1foreground0")
  internal static let _1foreground01 = ColorAsset(name: "1foreground01")
  internal static let _1foreground1 = ColorAsset(name: "1foreground1")
  internal static let background0 = ColorAsset(name: "background0")
  internal static let background1 = ColorAsset(name: "background1")
  internal static let background2 = ColorAsset(name: "background2")
  internal static let foreground0 = ColorAsset(name: "foreground0")
  internal static let foreground1 = ColorAsset(name: "foreground1")
  internal static let foreground2 = ColorAsset(name: "foreground2")
  internal static let foreground3 = ColorAsset(name: "foreground3")
  internal static let foreground4 = ColorAsset(name: "foreground4")
