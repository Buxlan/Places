...
class ProfileViewModel: NSObject {
    ...
    private lazy var _sections: [Section] = {
        ...
        let section1 = Section(title: L10n.Settings.SectionTitles.general, items: items)
        ...
        let section2 = Section(title: L10n.Settings.SectionTitles.communication, items: items)
